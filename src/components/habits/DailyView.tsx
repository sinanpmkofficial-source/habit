...
export default function DailyView({ onAddHabit, onEditHabit, onAddTask, onEditTask }: DailyViewProps) {
  ...
  return (
    <div className="w-full flex flex-col gap-5 px-4 md:px-6 xl:px-10 py-6 md:py-8">
      ...
      {/* Desktop overview strip — hidden on mobile */}
      ...
      {/* Two-column layout: habits left | tasks right (desktop); stacked on mobile */}
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 xl:gap-8">
        ...
        <div className="flex flex-col gap-6">
          ...
          {/* ── Tasks Section — mobile only (stacked below habits) ── */}
        ...
        <div className="hidden md:flex flex-col gap-6">
          {/* ── Tasks Section (always shown in right col on desktop) ── */}
          {(sectionTab === "all" || sectionTab === "tasks") && (
          <div className="flex flex-col gap-3">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2">
